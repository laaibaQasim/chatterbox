...
//            .addOnSuccessListener {
//                Log.d("OK","$user")
//                Log.d("Saved", "Finally we saved the user to Firebase Database")
//                val intent = Intent(this, MainActivity::class.java)
//                intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TASK.or(Intent.FLAG_ACTIVITY_NEW_TASK)
//                startActivity(intent)
//            }
//            .addOnFailureListener {
//                Log.d("NOt saved", "Failed to set value to database: ${it.message}")
//            }
//    }
private fun saveUserToFirebaseDatabase(profileImageUrl: String) {
    val uid = FirebaseAuth.getInstance().uid ?: ""
    ...
    val refPath = "/users/$uid"
    Log.d(TAG, "Reference Path: $refPath")
    ...
    ref.setValue(user)
        .addOnSuccessListener {
            Log.d(TAG, "Successfully saved the user to Firebase Database")
            val intent = Intent(this, MainActivity::class.java)
            intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TASK.or(Intent.FLAG_ACTIVITY_NEW_TASK)
            startActivity(intent)
        }
